...
/**
 * Shared email template wrapper with Jinda branding
 */
...
JINDA <span style="color:#fbbf24;">POS</span>
</h1>
...
Welcome to Jinda! Please verify your email address to activate your account.
</p>
...
If you didn't create a Jinda account, you can safely ignore this email.
</p>
</div>`
  ...
  try {
    ...
    await transporter.sendMail({
      from: `"Jinda" <${process.env.SMTP_USER}>`,
      to: email,
      subject: 'Verify Your Email — Jinda',
...
If you didn't request a password reset, your account is safe — just ignore this email.
  ...
  try {
    ...
    await transporter.sendMail({
      from: `"Jinda" <${process.env.SMTP_USER}>`,
      to: email,
      subject: 'Reset Your Password — Jinda',
...
If you didn't request this, please ignore this email.
  ...
  try {
    ...
    await transporter.sendMail({
      from: `"Jinda" <${process.env.SMTP_USER}>`,
      to: email,
      subject: 'License Recovery Code — Jinda',
...
⚠️ If you didn't attempt this login, please contact support immediately.
  ...
  try {
    ...
    await transporter.sendMail({
      from: `"Jinda" <${process.env.SMTP_USER}>`,
      to: email,
      subject: 'New Device Verification Required — Jinda',
