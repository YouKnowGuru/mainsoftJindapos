...
import {
  ...
  RefreshCw, Cloud, FileCheck, UserCheck, Clock, AlertTriangle,
  CheckCircle, HardDrive, Zap, UserCog, Scan, FileLock
} from 'lucide-react'
            ...
            {securityFeatures.map((feature) => (
              <InteractiveCard key={feature.title} className="p-5 md:p-6 bg-white border border-slate-100 shadow-sm">
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-11 h-11 rounded-xl bg-bhutan-maroon/10 text-bhutan-maroon flex items-center justify-center flex-shrink-0 group-hover:bg-bhutan-maroon group-hover:text-bhutan-gold transition-all duration-300">
